...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ url('/home') }}" class="logo">
            ...
            <span class="logo-mini">RANS</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>RANS</b> Office</span>
        </a>
...
@include('layouts.sidebar')
    ...
    <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
            Developed by <a href="https://itmedium.in" target=”_blank”>ITMedium Pvt. Ltd.</a>
        </div>
        <!-- Default to the left -->
        <?php $date = date('Y')?>
        <strong>&copy; {{$date}} - RANS Office Management </strong>
    </footer>
