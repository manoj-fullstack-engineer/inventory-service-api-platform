            ...
            <form id="form-item" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label>Time</label>
                            <input type="text" class="form-control" id="productIssueTime" name="productIssueTime" required>
                            <span class="help-block with-errors"></span>
                        </div>

                        <div class="form-group">
                            <label>Staff</label>
                            {!! Form::select('staff_id', $staffs, null, ['class' => 'form-control select', 'placeholder' => '-- Choose Staff --', 'id' => 'staff_id', 'required']) !!}
                            <span class="help-block with-errors"></span>
                        </div>
