...
<div class="box box-success">
    ...
    <div class="box-header">
        ...
        @else
        <a onclick="addForm()" class="btn btn-success pull-right" style="display: none;" style="margin-top: -8px;" ><i class="fa fa-plus"></i> Add Products</a>
        @endif
